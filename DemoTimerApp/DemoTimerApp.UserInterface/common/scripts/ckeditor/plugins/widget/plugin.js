 ...
 */
// © Siemens AG, 2017
//The plugin.js file has been modified inorder to hide the drag icon above the placeholder from Rich text editor widget
	...
	Widget.prototype = {
		...
		updateDragHandlerPosition: function() {
			...
			this.dragHandlerContainer.setStyles( {
				top: newPos.y + 'px',
				left: newPos.x + 'px',
				display: 'none'         //Updated to remove drag handler from rich text editor in the UI Framework
			} );
