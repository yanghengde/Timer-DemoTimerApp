...
/* © Siemens AG, 2018
 * Not a Contribution.
 * The viewer.js file has been modified inorder to  integrate with the framework and implement the required behaviour.
 * (Open file and outline in sidebar is removed)
 */
...
/***/ (function (module, exports, __webpack_require__) {
            ...
            function configure(PDFJS) {
                ...
                PDFJS.workerSrc = 'common/scripts/pdfjs/pdf.worker.js';
            ...
            var PDFViewerApplication = {
                ...
                close: function close() {
                    var errorWrapper = document.getElementById('pdf-full-screen');
                    ...
                    customEvent.initEvent('pdf-full-screen-closed', true, true);
                ...
                unbindEvents: function unbindEvents() {
                    ...
                    eventBus.off('close', webViewerClose);
                    ...
                    value: function switchView(view) {
                        ...
                        switch (view) {
                            ...
                            case SidebarView.OUTLINE:
                                if (this.outlineButton && this.outlineButton.disabled) {
                                    return;
                                }
